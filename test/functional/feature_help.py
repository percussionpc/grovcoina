...
"""Verify that starting grovcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start grovcoin with -h for help text")
        ...
        self.log.info("Start grovcoin with -version for version information")
        ...
        self.log.info("Start grovcoind with -fakearg to make sure it does not start")
