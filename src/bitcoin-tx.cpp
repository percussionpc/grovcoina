...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " grovcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  grovcoin-tx [options] <hex-tx> [commands]  Update hex-encoded grovcoin transaction\n" +
            "or:     grovcoin-tx [options] -create [commands]   Create hex-encoded grovcoin transaction\n" +
            "\n";
